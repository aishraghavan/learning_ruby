...
class TestGame < Test::Unit::TestCase
    ...
    def test_room()
        description  = """This room has gold in it you can grab. There's a door to the north."""
        gold = Room.new("GoldRoom",description)
        assert_equal("GoldRoom", gold.name)
        assert_equal(description, gold.description)
